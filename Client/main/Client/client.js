...
<img src="lios-flat.svg" style="width: 100px; height: auto; border-radius: 50px;">
<p id="new" style="bottom: 55px; left: 5px;">&nbsp;&nbsp;{user}:{content}</p>
...
const typervalue = document.getElementById("chattyper").value;
...
function addNewMessage(message) {
  var newMsg = document.getElementById("new");
  chat_window.innerHTML += basemessage;
  newMsg.innerText = message;
  newMsg.id.replace("new", "old");
}
function handleChat(message) {}

send.addEventListener("submit", () => {
  addNewMessage(typervalue);
  document.getElementById("chattyper").value = ""
});
/*
